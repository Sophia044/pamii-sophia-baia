...
>(function AvatarBadge({ className, size, ...props }, ref) {
  ...
  return (
    <UIAvatar.Badge
      ref={ref}
      {...props}
      className={avatarBadgeStyle({ parentVariants: { size: parentSize }, size, class: className })}
    />
  );
});
...
>(function AvatarFallbackText({ className, size, ...props }, ref) {
  ...
  return (
    <UIAvatar.FallbackText
      ref={ref}
      {...props}
      className={avatarFallbackTextStyle({ parentVariants: { size: parentSize }, size, class: className })}
    />
  );
});
...
>(function AvatarImage({ className, ...props }, ref) {
  return (
    <UIAvatar.Image
      ...
      // @ts-expect-error : workaround for web image style
